...
print("Breast cancer, should be (0.9906103286384976, 0.951048951048951)")
print(log_reg_accuracy(cancer.data, cancer.target))

from sklearn.datasets import load_iris
iris = load_iris()
print("Iris 2 vs all, should be (0.9732142857142857, 0.9736842105263158)")
print(log_reg_accuracy(iris["data"], iris["target"]==2))
print("Iris 1 vs all, should be (0.7589285714285714, 0.6578947368421053)")
print(log_reg_accuracy(iris["data"], iris["target"]==1))
print("Iris 0 vs all, should be (1.0, 1.0)")
print(log_reg_accuracy(iris["data"], iris["target"]==0))
...
print(log_reg_accuracy(bit_data, bit_target))
